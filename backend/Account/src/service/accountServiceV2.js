...
/**
 * Handles user detail request
 * @param {Object} messageContent - The content of the message received
 * @param {string} messageContent.userId - The ID of the user to fetch details for
 */
